...
function RouteManager(mm) {
  ...
  if (options.reverseProxy) {
    // this.installReverseHttpProxyRoutes(this.app, mm, this.cdifInterface);
    // must put this before body parser because it will consume incoming requests
    this.app.use('/api-proxy/:deviceID', require('./routes/user'));
    this.app.use("/api-proxy/3a509370-6db9-5fd0-9e98-4a912810d805", apiProxy("http://10.0.0.122:9527/"));
    // this.app.all("/api-proxy/3a509370-6db9-5fd0-9e98-4a912810d805", apiProxy("http://10.0.0.122:9527/devices/3a509370-6db9-5fd0-9e98-4a912810d805/invoke-action"));
    // this.app.use("/api-proxy/055a2472-fd32-595f-add1-726f9987d4d3", apiProxy("https://api.apemesh.com:3049/devices/055a2472-fd32-595f-add1-726f9987d4d3/invoke-action"));
    this.app.use("/api-proxy/055a2472-fd32-595f-add1-726f9987d4d3", apiProxy("http://ali-weather.showapi.com/") );
  }
...
RouteManager.prototype.installReverseHttpProxyRoutes = function(app, mm, ci) {
  // app.use('/', require('./routes/user'));
  // app.use('/', require('./routes/reverse-proxy')(app, mm, this.cdifInterface));
