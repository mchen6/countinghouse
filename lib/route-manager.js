...
RouteManager.prototype.installNormalRoutes = function() {
  ...
  if (options.debug === true) {
    this.app.use('/load-module',    require('./routes/load-module')(mm, this.cdifInterface));
    this.app.use('/unload-module',  require('./routes/unload-module')(mm, this.cdifInterface));
    this.app.use('/restart-module', require('./routes/restart-module')(mm, this.cdifInterface));
  }
