...
DeviceManager.prototype.onDeviceOnline = function(cdifDevice, moduleInstance, moduleName, packageInfo) {
  ...
  validator.validateDeviceSpec(cdifDevice.spec, function(error) {
    ...
    UUID.v5({
        ...
        if (!isMainThread) {
          this.workerMessage.sendDeviceOnlineMessageToParent({deviceID: uuid, spec: cdifDevice.spec, moduleName: moduleName, packageInfo: packageInfo});
