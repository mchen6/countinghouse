...
var DeviceError = require('./cdif-error').DeviceEror;
...
module.exports = {
  ...
  invokeAction: function(deviceBaseUrl, serviceID, actionName, input, callback) {
    ...
    this.request(options, function(error, response, body) {
      ...
      return callback(null, {output: body.output});
    });
  }
};
