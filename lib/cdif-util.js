...
var CdifClient  = require('./cdif-client');
...
module.exports = {
  ...
  //TODO: add optional userKey support, make parameters as a object
  // createServiceClient: function(deviceID, serviceID, callback) {
  createServiceClient: function(options, callback) {
    var deviceID  = options.deviceID;
    var serviceID = options.serviceID;
    var userKey   = options.userKey || null;
    ...
    this.dm.emit('querydevice', deviceID, function(error, cdifDevice) {
      ...
      return callback(null, new CdifClient(this.ci, userKey, deviceID, serviceID));
    }.bind(this));
  }
