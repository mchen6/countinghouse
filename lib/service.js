...
Service.prototype.getInputKey = function(deviceID, serviceID, actionName, input) {
...
Service.prototype.updateStateFromAction = function(action, input, output, callback) {
  ...
  if (options.enableAPICache === true && action.apiCache != null) {
    var hashString = this.getInputKey(this.device.deviceID, this.serviceID, action.name, input);
...
Service.prototype.getApiInputKeyAccessInfo = function(key) {
  ...
  if (this.apiKeyStats[key] == null) {
    ...
    this.apiKeyStats[key].keyObject  = new InputKeyClass(); // the event emission object
...
Service.prototype.getValueFromAPICache = function(actionName, timeout, input, callback) {
  var hashString = this.getInputKey(this.device.deviceID, this.serviceID, actionName, input);
        ...
        this.updateStateFromAction(action, input, output, function(updated) {
          ...
          if (options.enableAPICache === true && action.apiCache != null && updated === true) {
            ...
            if (this.apiKeyStats[hashString] != null && this.apiKeyStats[hashString].keyObject != null) {
              ...
              // publisher.publish(hashString, 'invalidated');
              this.apiKeyStats[hashString].keyObject.emit('valueinvalidated', output);
            }
...
Service.prototype.subscribeEvent = function(subscriber, actionName, input, callback) {
  //TODO: check validness of actionName, inputKey
  var action = this.actions[actionName];
  ...
  this.validateActionCall(action, input, true, function(err, data) {
    ...
    if (this.apiKeyStats[hashString] != null && this.apiKeyStats[hashString].keyObject != null) {
      this.apiKeyStats[hashString].keyObject.addListener('valueinvalidated', subscriber);
      callback(null, null);
    }
  }.bind(this));
