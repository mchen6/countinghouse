...
ConnectManager.prototype.verifyConnect = function(user, pass, callback) {
  ...
  //     return callback(new McpForgeError('cannot verify password'), null, null);
  //   }
  //   if (this.device.user !== user) {
  //     return callback(new McpForgeError('username not match'), null, null);
  //   }
  ...
  //     }
  //     if (!err) {
  //       return callback(new McpForgeError('password not match'), null, null);
  //     }
  //     return callback(new McpForgeError(err.message), null, null);
  //   }.bind(this));
  // } else {
  //   callback(null, null, null);
  // }
...
ConnectManager.prototype.processConnect = function(user, pass, callback) {
  ...
  //     callback(new McpForgeError('cannot authenticate this device'), null, null);
  //   } else {
  //     this.device.connectionState = 'connected';
  //     callback(null, null, null);
  //   }
