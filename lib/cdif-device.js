...
// CdifDevice.prototype.setDeviceTimeout = function(eventName, session) {
//   if (this.online === false) {
//     if (eventName !== 'onconnect') {
//       console.error('error: new op: ' + eventName + ' for offlined device: ' + this.spec.device.friendlyName);
//       console.error('do connect first');
//     } else {
//       this.online = true;  // allow connect for a previously offlined device
//     }
//   }

//   if (session.uuid == null) {
//     session.callback(new CdifError('not a valid request for setting device timeout'), null);
//     return false;
//   }

//   // TODO: configurable max no. of parallel ops
//   if (this.installTimeout(eventName, session) === true) {
//     return true;
//   } else {
//     session.callback(new CdifError('install timer for existed session'), null);
//     return false;
//   }
// };

// CdifDevice.prototype.installTimeout = function(eventName, session) {
//   if (this.timer[eventName] == null) {
//     this.timer[eventName] = {};
//   }

//   if (this.timer[eventName][session.uuid] == null) {
//     var timer = new Timer(this, eventName, session);
//     this.timer[eventName][session.uuid] = setTimeout(timer.expire.bind(timer), 30000);
//     return true;
//   } else {
//     return false;
//   }
...
// CdifDevice.prototype.clearDeviceTimeout = function(eventName, session) {
//   if (this.timer[eventName][session.uuid]) {
//     clearTimeout(this.timer[eventName][session.uuid]);
//     delete this.timer[eventName][session.uuid];
//   }
// };
