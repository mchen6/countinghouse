...
// CHUtil is required lazily below, inside the functions that need it.
  ...
  const ctx = {
    ...
    call: (address, input, opts) => {
      ...
      return new Promise((resolve, reject) => {
        // lazy: see the comment on the callAddress require at the top of
        // this file -- handler-ctx.js is reached by the serverless
        // module-validator path, and a top-level require of
        // countinghouse-util would open a Redis socket there.
        const CHUtil = require('./countinghouse-util');
