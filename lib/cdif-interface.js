...
CdifInterface.prototype.eventSubscribe = function(subscriber, deviceID, serviceID, actionName, inputKey, token, callback) {
  this.deviceManager.emit('subscribe', subscriber, deviceID, serviceID, actionName, inputKey, token, callback);
};

CdifInterface.prototype.eventUnsubscribe = function(subscriber, deviceID, serviceID, token, session) {
  this.deviceManager.emit('unsubscribe', subscriber, deviceID, serviceID, token, session);
};
