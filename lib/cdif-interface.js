...
CdifInterface.prototype.invokeJobs = function(deviceID, serviceID, actionName, input, callback) {
    this.deviceManager.emit('invokejobs', deviceID, serviceID, actionName, input, callback);
};
