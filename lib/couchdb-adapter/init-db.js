...
// map's source is transmitted to CouchDB as a string (via JSON.stringify
// -> Function.prototype.toString below) and run there, not in this
// process -- `emit` is a CouchDB view-server global, not a real function
// here.
function byAppKeyWithBasicInfoMap(doc) {
