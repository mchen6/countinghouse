...
module.exports = {
  setOptions: function(argv) {
    ...
    this.enableWorkerThread      = (argv.workerThread    === true) ? true : false;
  ...
  getOptions: function() {
    return {
      ...
      enableVerifyAndPublish:   this.enableVerifyAndPublish,
      enableAPIMonitor:         this.enableAPIMonitor,
      enableAPICache:           this.enableAPICache,
      loadProfile:              this.loadProfile,
      wetty:                    this.wetty,
      logStream:                this.logStream,
      reverseProxy:             this.reverseProxy,
      enableWorkerThread:       this.enableWorkerThread,
