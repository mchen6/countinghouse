...
module.exports = {
  setOptions: function(argv) {
    ...
    // AUTHORING_TOOLS, gated in lib/mcp/gateway.js). See gateway.js's
    // dispatchAuthoringTool comment for why this must stay a second gate on
    // top of isAdmin, not a substitute for it.
