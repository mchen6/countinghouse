...
// to previous msg from parent, in this case we set special msg id to null
WorkerMessage.prototype.sendDeviceOnlineMessageToParent = function(deviceID) {
  return this.sendMessageToParent('deviceonline', null, {deviceID: deviceID});
};
