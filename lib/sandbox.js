...
global.McpForgeUtil     = require('./mcpforge-util');
global.McpForgeDevice   = require('./mcpforge-device');
global.McpForgeError    = require('./mcpforge-error').McpForgeError;
global.DeviceError  = require('./mcpforge-error').DeviceError;
