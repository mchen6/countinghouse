...
OAuthDevice.prototype.connect = function(user, pass, callback) {
  if (this.oauth_version === '1.0') {
    ...
    var requestUrl = this.oauth_requestUrl + '?oauth_callback=' + querystring.escape(CHUtil.getHostProtocol() + CHUtil.getHostIp() + ':' + options.port + '/callback_url?deviceID=' + this.deviceID);
