//20200709
//TODO: we shall need to rewrite wss code,
//the idea is a WS client can subscribe to a specific deviceID (with AppKey guard), and any message populated by that device module
//with the form of this.emit('deviceevent', {...message_content...}) should be received by any subscribed client
//e.g. if we received an API request and do something in device module, the device module can broadcast the return results, or other customized data to subscribed WS clients
...
module.exports = {
  ...
  // delete all clientIDs which are managed by this mcpforge instance from redis cache
