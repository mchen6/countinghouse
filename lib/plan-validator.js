...
//
// Requires only tool-name.js (no requires of its own), never
// mcp/tool-registry.js: that module opens a Redis socket and a timer at
// require time, which would keep this validator's test process alive.
