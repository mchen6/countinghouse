...
// Extracted from the metering logic that currently lives inline in
// lib/session.js (Session.prototype.updateRedisUserRecord) and
// lib/user-auth.js (balance/priceRecord lookup) -- see redis-provider.js for
// the built-in implementation that mirrors that existing behavior.
