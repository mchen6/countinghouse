  ...
  startVSCode: function(workingDir, apiDesignID, callback) {
    ...
    if (this.monitor != null) {
      this.monitor.stop(function() {
        this.monitor = respawn(['/usr/bin/code-server', '--disable-telemetry', '--user-data-dir', '/root/mcpforge-workspace/.UserData', '--extensions-dir', '/root/mcpforge-workspace/.ExtensionData', workingDir], {
