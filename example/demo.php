<?php
    ...
    $context = stream_context_create(array(
        'http' => array(
            'header' => "X-MCPForge-Key: <用户appKey>\r\n".
    ...
    // Send the request
    $response = file_get_contents('https://api.mcpforge.com:3049/devices/f5dc73f9-b739-5ee2-add7-e499da04c6ec/invoke-action', FALSE, $context);
