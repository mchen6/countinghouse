...
describe('test18: invoke with BSON content-type with binary data', function() {
  this.timeout(0);
  var req = BSON.serialize({ serviceID: 'urn:countinghouse-com:serviceID:echoService', actionName: 'echo', input: {foo: [{item1: '111', item2: false}], bar: '222', binaryData: Buffer.from('abcdefg')} });
