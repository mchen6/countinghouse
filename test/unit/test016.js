...
describe('test16: invoke error expect unknown error', function() {
  this.timeout(0);
  const req = { serviceID: 'urn:countinghouse-com:serviceID:errorInfoTestService', actionName: 'testErrorInfo', input: {foo: "444"} };

  it('invoke error expect unknown error', (done) => {
