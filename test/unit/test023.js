...
describe('test23: invoke return string type as output', function() {
  this.timeout(0);
  const req = { serviceID: 'urn:countinghouse-com:serviceID:errorInfoTestService', actionName: 'testStringTypeReturnError', input: {} };

  it('invoke return string type as output', (done) => {
