...
describe('test22: invoke return number type as output', function() {
  this.timeout(0);
  const req = { serviceID: 'urn:countinghouse-com:serviceID:errorInfoTestService', actionName: 'testNumberTypeReturnError', input: {} };

  it('invoke return number type as output', (done) => {
