...
describe('test28: invoke async action which throw exception', function() {
  this.timeout(0);
  var req = { serviceID: 'urn:countinghouse-com:serviceID:errorInfoTestService', actionName: 'testThrowErrorAsync', input: {} };

  it('invoke async action which throw exception', function(done) {
