...
describe('test27: invoke action which throw exception', function() {
  this.timeout(0);
  var req = { serviceID: 'urn:countinghouse-com:serviceID:errorInfoTestService', actionName: 'testThrowError', input: {} };

  it('invoke action which throw exception', function(done) {
    ...
    .expect(500, function(err, res) {
      ...
      if (res.body.topic !== 'device error' ||
        ...
        return done(new Error('test27 fail'));
      }
      return done();
    });
  });
