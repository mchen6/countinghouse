...
describe('test21: invoke return null type as output', function() {
  this.timeout(0);
  const req = { serviceID: 'urn:countinghouse-com:serviceID:errorInfoTestService', actionName: 'testNullReturnError', input: {} };

  it('invoke return null type as output', (done) => {
