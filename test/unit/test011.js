...
describe('test11: invoke specify incorrect input type', function() {
  this.timeout(0);
  var req = { serviceID: 'urn:countinghouse-com:serviceID:echoService', actionName: 'echo', input: null };
  ...
  it('invoke without specifying input', function(done) {
    ...
    .expect(500, function(err, res) {
      ...
      if (res.body.code !== 'INPUT_DATA_VALIDATION_FAIL' || res.body.fault.reason !== '空数据') {
