...
describe('test8: invoke specify incorrect input type', function() {
  this.timeout(0);
  var req = { serviceID: 'urn:countinghouse-com:serviceID:echoService', actionName: 'echo', input: 'input' };
  ...
  it('invoke without specifying input', function(done) {
    ...
    .expect(500, function(err, res) {
      ...
      if (res.body.code !== 'INPUT_DATA_VALIDATION_FAIL' || res.body.fault.reason !== '数据不是object类型') {
