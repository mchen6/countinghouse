...
describe('test30: invoke async action which throws inside a never-settling Promise', function() {
  this.timeout(0);
  const req = { serviceID: 'urn:countinghouse-com:serviceID:errorInfoTestService', actionName: 'testAsyncThrowInAsync', input: {} };
  ...
  it('never settles, so the request times out as DEVICE_NOT_RESPONDING', (done) => {
