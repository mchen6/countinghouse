...
describe('test24: invoke return boolean type as output', function() {
  this.timeout(0);
  const req = { serviceID: 'urn:countinghouse-com:serviceID:errorInfoTestService', actionName: 'testBooleanTypeReturnError', input: {} };

  it('invoke return boolean type as output', (done) => {
