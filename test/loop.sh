...
curl -H "Content-Type: application/json" -H "X-Apemesh-Key: 123456789" -X POST -d '{"serviceID":"urn:cdif-io:serviceID:手机归属地查询","actionName":"查询","input":{"phoneNum": "13916039070"}}' http://10.0.0.132:9527/devices/7ef12cfe-d591-5380-9808-4bd1471c92bc/invoke-action&
curl -H "Content-Type: application/json" -H "X-Apemesh-Key: 123456789" -X POST -d '{"serviceID":"urn:cdif-io:serviceID:手机归属地查询","actionName":"查询","input":{"phoneNum": "13607187811"}}' http://10.0.0.132:9527/devices/7ef12cfe-d591-5380-9808-4bd1471c92bc/invoke-action&
	sleep 1
done
