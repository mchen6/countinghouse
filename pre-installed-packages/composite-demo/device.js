const fs = require('fs');
const com_countinghouse_compositeService_run = CHUtil.loadFile(`${__dirname}/com-countinghouse-compositeService-run.js`);
...
const INTERNAL_API_KEY = 'composite-demo-internal';
