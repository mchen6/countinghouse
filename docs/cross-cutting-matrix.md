...
`/devices/:deviceID/schema`, `/device-list`,
`/devices/:deviceID/package-info` and `/devices/:deviceID/download-package`
...
that those five are unguarded — closing it is separate work from this
change.
